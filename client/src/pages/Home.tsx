...
import { ExternalLink, ChevronDown, Droplets, Shield, Sparkles, Leaf, Sun, Heart } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[90vh] lg:min-h-[85vh]">
            ...
            <div className="order-2 lg:order-1 text-center lg:text-left pb-8 lg:pb-0">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start px-4 sm:px-0">
                <a href={content.product.amazonLink} target="_blank" rel="noreferrer" className="w-full sm:w-auto" data-testid="link-hero-shop">
                  <RippleButton size="lg" className="w-full sm:w-auto bg-stone-900 text-white hover:bg-stone-800 rounded-none px-8 sm:px-10 h-12 sm:h-14 text-xs sm:text-sm tracking-[0.15em] sm:tracking-[0.2em] uppercase transition-all duration-500 shadow-lg hover:shadow-xl" data-testid="button-hero-shop">
                    Shop Now <ExternalLink className="ml-2 sm:ml-3 w-4 h-4 opacity-60" aria-hidden="true" />
                  </RippleButton>
                </a>
                <Button 
                  variant="outline" 
      ...
      {/* Product Highlight / External Shop */}
          ...
          <div className="max-w-4xl mx-auto bg-card p-8 md:p-16 shadow-2xl border border-border/50 text-center">
             <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="order-2 md:order-1 text-left">
                  ...
                  <a href={content.product.amazonLink} target="_blank" rel="noreferrer" data-testid="link-product-amazon">
                    <RippleButton className="w-full bg-primary text-primary-foreground hover:bg-primary/90 rounded-none h-14 text-sm tracking-[0.2em] uppercase" data-testid="button-product-amazon">
                      Purchase on Amazon
                    </RippleButton>
                  </a>
                  <p className="mt-4 text-xs text-muted-foreground text-center uppercase tracking-wider" data-testid="text-amazon-fulfillment">Secure fulfillment by Amazon</p>
                </div>
